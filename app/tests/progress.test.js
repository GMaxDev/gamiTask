...
import {createProgress,completeTask,completePomodoro,levelOf,levelInfo,ACHIEVEMENTS} from '../src/progress.js';
...
test('saved data is sanitised',()=>{
 const p=createProgress({coins:-5,xp:'x',achievements:['first-task','bogus'],pomos:2.7});
